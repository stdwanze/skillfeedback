...
/**
 * Strings for component 'organizer', language 'de', version '3.9'.
 *
 * @package     organizer
 * @category    string
...
$string['allowsubmissionsanddescriptionfromdatesummary'] = 'Die MIA-Projektdetails und die Registrierung stehen zur Verfügung ab <strong>{$a}</strong>';
$string['allowsubmissionsfromdate'] = 'Anmeldebeginn';
$string['allowsubmissionsfromdate_help'] = 'Kreuzen Sie diese Option an um den Teilnehmer/innen den Zugang zu diesem MIA-Projekt erst ab einem bestimmten Zeitpunkt zu ermöglichen.';
...
$string['changegradewarning'] = 'In diesem MIA-Projekt sind bereits Termine bewertet worden. Bei einer Änderung der Bewertungseinstellungen sind Neuberechnungen der Bewertungen erforderlich. Sie müssen ggfs. die Neuberechnung gesondert starten.';
...
$string['configintro'] = 'Die Werte die Sie hier einstellen, bestimmen die Standardwerte, die im Einstellungsformular aufscheinen, wenn Sie einen neuen MIA-Projekt erstellen.';
...
$string['configmaximumgrade'] = 'Voreinstellung für den Wert im Feld "Höchste Bewertung" beim Erstellen eines neuen MIA-Projekts. Diese Einstellung entspricht dem Beurteilungsmaximum, das ein/e Teilnehmer/in erhalten kann.';
...
$string['crontaskname'] = 'MIA-Projekt cron Job';
...
$string['err_availablepastdeadline'] = 'Dieser Slot kann nicht nach dem Ablauf des MIA-Projekts am {$a->deadline} verfügbar gemacht werden.';
...
$string['err_isgrouporganizer_app'] = 'Der Gruppenmodus kann nicht verändert werden, da bereits gebuchte Termine in diesem MIA-Projekt existieren!';
...
Die Trainer/innen des Kurses ermöglichen Ihnen, sich nochmals im MIA-Projekt {$a->organizername} zu einem noch freien Termin anzumelden.
...
Die Trainer/innen des Kurses ermöglichen Ihnen, sich nochmals im MIA-Projekt {$a->coursefullname} zu einem noch freien Termin anzumelden.
...
$string['finalgrade'] = 'Dieser Wert wurde in der Kursbewertung eingetragen und kann im MIA-Projekt nicht überschrieben werden.';
...
$string['hidecalendar_help'] = 'Stellen Sie hier ein, ob der Kalender in diesem MIA-Projekt ausgeblendet werden soll.';
$string['hour'] = 'h';
$string['hour_pl'] = 'hrs';
$string['id'] = 'ID';
...
$string['infobox_description_title'] = 'MIA-Projektbeschreibung';
...
$string['infobox_organizer_expired'] = 'Dieser MIA-Projekt lief am {$a->date} um {$a->time} ab';
$string['infobox_organizer_expires'] = 'Dieser MIA-Projekt läuft am {$a->date} um {$a->time} ab.';
$string['infobox_organizer_never_expires'] = 'Dieser MIA-Projekt läuft nicht ab.';
...
$string['introeditor_error'] = 'Eine Beschreibung des MIA-Projekts muss vorhanden sein!';
...
$string['isgrouporganizer_help'] = 'Wählen Sie bei Bedarf einen Gruppenmodus für diesen MIA-Projekt aus. Dabei gibt es folgende Modi:
...
$string['legend_organizer_expired'] = 'MIA-Projekt abgelaufen';
...
$string['maillink'] = 'Der MIA-Projekt ist unter <a href="{$a}">diesem</a> Link verfügbar.';
$string['maxparticipants'] = 'Höchstanzahl der Teilnehmer/innen';
$string['maxparticipants_help'] = 'Bestimmt die maximale Anzahl Teilnehmer/innen die sich für die jeweiligen Slots registrieren können. Bei GruppenMIA-Projektn ist diese Anzahl immer auf eine Gruppe begrenzt.';
...
$string['messageprovider:appointment_reminder_student'] = 'MIA-Projekt Terminerinnerung';
$string['messageprovider:appointment_reminder_teacher'] = 'MIA-Projekt Terminerinnerung (Trainer/in)';
$string['messageprovider:assign_notify_student'] = 'MIA-Projekt Zuweisung durch Trainer/in';
$string['messageprovider:assign_notify_teacher'] = 'MIA-Projekt Zuweisung';
$string['messageprovider:edit_notify_student'] = 'MIA-Projekt Änderungen';
$string['messageprovider:edit_notify_teacher'] = 'MIA-Projekt Änderungen (Trainer/in)';
$string['messageprovider:eval_notify_student'] = 'MIA-Projekt Bewertungsbenachrichtigung';
$string['messageprovider:group_registration_notify_student'] = 'MIA-Projekt Gruppenregistrierung Benachrichtigung';
$string['messageprovider:manual_reminder_student'] = 'MIA-Projekt manuelle Terminerinnerung';
$string['messageprovider:register_notify_teacher'] = 'MIA-Projekt Registrierungsbenachrichtigung';
$string['messageprovider:register_notify_teacher_queue'] = 'MIA-Projekt Benachrichtigung über Wartelistenanmeldung';
$string['messageprovider:register_notify_teacher_register'] = 'MIA-Projekt Registrierungsbenachrichtigung';
$string['messageprovider:register_notify_teacher_reregister'] = 'MIA-Projekt Re-Registrierungsbenachrichtigung';
...
$string['messageprovider:register_notify_teacher_unregister'] = 'MIA-Projekt Abmeldungsbenachrichtigung';
$string['messageprovider:register_reminder_student'] = 'MIA-Projekt Registrierungserinnerung';
$string['messageprovider:slotdeleted_notify_student'] = 'MIA-Projekt Slot absagen';
$string['messageprovider:test'] = 'MIA-Projekt Test Nachricht';
...
$string['min'] = 'min';
$string['min_pl'] = 'mins';
$string['modformwarningplural'] = 'Diese Felder können nicht bearbeitet werden, da es in diesem MIA-Projekt schon angemeldete Teilnehmer/innen gibt!';
$string['modformwarningsingular'] = 'Dieses Feld kann nicht bearbeitet werden, da es in diesem MIA-Projekt schon angemeldete Teilnehmer/innen gibt!';
$string['modulename'] = 'MIA-Projekt';
$string['modulename_help'] = 'MIA-Projekt ermöglichen es den Trainer/innen MIA-Projekte bzw. Zeitfenster für die Teilnehmer/innen bereitzustellen.';
$string['modulenameplural'] = 'MIA-Projekte';
...
$string['mymoodle_organizer_expired'] = 'Dieser MIA-Projekt lief am {$a->date} um {$a->time} ab. Sie können ihn nicht mehr benutzen';
$string['mymoodle_organizer_expires'] = 'Dieser MIA-Projekt läuft am {$a->date} um {$a->time} ab';
...
$string['no_due_my_slots'] = 'All Ihre Zeitslots in diesem MIA-Projekt sind abgelaufen oder verborgen';
$string['no_due_slots'] = 'Alle in diesem MIA-Projekt erstellten Zeitslots sind abgelaufen';
$string['no_my_slots'] = 'Sie haben in diesem MIA-Projekt keine Slots erstellt';
$string['no_slots'] = 'Es wurden keine Zeitslots in diesem MIA-Projekt erstellt';
...
$string['nosingleslotprintfields'] = 'Es kann kein Ausdruck vorgenommen werden. Es wurden keine Profilfelder zum Ausdruck bestimmt. Siehe die MIA-Projekt-Einstellungen.';
...
$string['organizercommon'] = 'MIA-Projekt Einstellungen';
$string['organizername'] = 'Name des MIA-Projekts';
...
$string['pluginadministration'] = 'MIA-Projekt Administration';
$string['pluginname'] = 'MIA-Projekt';
...
$string['reg_status_organizer_expired'] = 'MIA-Projekt abgelaufen';
...
$string['resetorganizerall'] = 'Alle Daten des MIA-Projekts löschen (Slots & Termine)';
$string['reviewsubmit'] = 'Zeitslots ansehen';
$string['rewievslotsheader'] = 'Zeitslots ansehen';
$string['search:activity'] = 'MIA-Projekt - Aktivitätsinformation';
$string['sec'] = 'sek';
$string['sec_pl'] = 'seks';
...
Beachten Sie dabei, dass Sie keinen Termin mehr im MIA-Projekt {$a->organizername} haben!
...
Beachten Sie dabei, dass Sie keinen Termin mehr im MIA-Projekt {$a->organizername} haben!
Für einen Ersatztermin folgen Sie bitte dem Link: {$a->courselink}';
$string['slotdeleted_notify_student:group:smallmessage'] = 'Ihr Termin am {$a->date} um {$a->time} im MIA-Projekt "{$a->organizername}" wurde abgesagt.';
$string['slotdeleted_notify_student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Termin abgesagt';
$string['slotdeleted_notify_student:smallmessage'] = 'Ihr Termin am {$a->date} um {$a->time} im MIA-Projekt "{$a->organizername}" wurde abgesagt.';
...
$string['status_no_entries'] = 'Für diesen MIA-Projekt sind keine Teilnehmer/innen angemeldet.';
...
$string['timeslot'] = 'MIA-Projekt-Termin';
...
$string['warninggroupmode'] = 'Sie müssen den Gruppenmodus einschalten und eine Gruppierung auswählen, um einen GruppenMIA-Projekt zu erstellen!';
